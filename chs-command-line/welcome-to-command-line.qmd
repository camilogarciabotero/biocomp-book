...
touch new-file.txt
```
The `new-file.txt` is empty and created on your current location unless you assign another path when creating it. We suggest to take a loo at [Allison Horst](https://github.com/allisonhorst/stats-illustrations), especially on how to name files depending on the *case* see [Fig. @fig-naming-files]
