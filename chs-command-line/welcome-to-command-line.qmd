...
Before diving into an [:answer](../chs-challenges-demos/demo-motif-search.qmd#motif-search) take your time to think and solve it by your own.
...
See a possible script that solve the challenge [:here](../chs-challenges-demos/demo-motif-search.qmd#motif-search-in-multiple-files)
:::
...
[:sandbox](https://sandbox.bio/playground)