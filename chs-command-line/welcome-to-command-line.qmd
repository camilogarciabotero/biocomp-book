...
touch new-file.txt
```
The `new-file.txt` is empty and created on your current location unless you assign another path when creating it.

::: {.column-margin}
![Different conventions for naming files or directories as a good computational practice. Illustration was made by [Allison Horst](https://github.com/allisonhorst/stats-illustrations)](imgs-cli/naming-files.png){#fig-naming-flies fig-align="center"}
::: 
