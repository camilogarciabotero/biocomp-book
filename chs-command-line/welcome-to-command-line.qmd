...
When facing the CLI several issues or problems will arise. As for any other unintuitive challenge, a complete text interface   Handling errors.
Getting help
Patience
...
![Redirecting](imgs-cli/redirection.png)

### Pipe

![](imgs-cli/pipeflow.png)
