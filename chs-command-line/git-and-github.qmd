...
There are at least **six** basic commands. Three of them allow recording local changes and the other three help you to inspect the state of the changes. So, to start recording changes in a folder you must **initialize** this directory/repository using `git init`. This is a one-time command to start.

### The local workflow

![](imgs-cli/gitlocal.png){#local-workflow}
