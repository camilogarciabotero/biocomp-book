...
::: {.callout-note}
Sometimes other fields might add interested value to the understanding of the computational biology area. This callout remarks some of them and aim to explain these intersections.
:::
