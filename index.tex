...
\begin{tcolorbox}[standard jigsaw,bottomtitle=1mm, left=2mm, coltitle=black, opacitybacktitle=0.6, rightrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, opacityback=0, arc=.35mm, bottomrule=.15mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Challenge}, toptitle=1mm, titlerule=0mm, toprule=.15mm, colframe=quarto-callout-warning-color-frame, colback=white, leftrule=.75mm]
