...
\begin{tcolorbox}[standard jigsaw,opacityback=0, colbacktitle=quarto-callout-warning-color!10!white, arc=.35mm, bottomtitle=1mm, bottomrule=.15mm, colback=white, leftrule=.75mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Challenge}, opacitybacktitle=0.6, toprule=.15mm, coltitle=black, rightrule=.15mm, left=2mm, titlerule=0mm, toptitle=1mm, colframe=quarto-callout-warning-color-frame]
