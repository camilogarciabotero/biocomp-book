...
\addcontentsline{toc}{subsection}{Needleman-Wunsch (global alignment)}

\hypertarget{smith-waterman-local-alignment}{%
\subsection*{Smith-Waterman (local
alignment)}\label{smith-waterman-local-alignment}}
\addcontentsline{toc}{subsection}{Smith-Waterman (local alignment)}
...
\addcontentsline{toc}{section}{What is a phylogenetic tree}
...
\addcontentsline{toc}{section}{Mehtods for phylogenetic reconstruction}
...
\addcontentsline{toc}{section}{Building a phylogenetic reconstruction}
...
\addcontentsline{toc}{subsection}{Evolutionary substitution model}

\hypertarget{maximum-likelihood}{%
\subsection*{Maximum likelihood}\label{maximum-likelihood}}
\addcontentsline{toc}{subsection}{Maximum likelihood}

\hypertarget{bayesian-inference}{%
\subsection*{Bayesian inference}\label{bayesian-inference}}
\addcontentsline{toc}{subsection}{Bayesian inference}
...
\addcontentsline{toc}{section}{Platforms yields}

\hypertarget{reads-main-differences}{%
\section*{Reads main differences}\label{reads-main-differences}}
\addcontentsline{toc}{section}{Reads main differences}
...
\addcontentsline{toc}{section}{Oxford Nanopore Technology (ONT)
principle}
...
\addcontentsline{toc}{subsection}{The fast5 file format}
...
\addcontentsline{toc}{section}{The problem of assembling genomes}
...
\addcontentsline{toc}{section}{Understanding genome difficulties}
...
\addcontentsline{toc}{section}{Read mapping algorithms and programs}

\hypertarget{burrow-wheeler-alignment}{%
\subsection*{Burrow-Wheeler-Alignment}\label{burrow-wheeler-alignment}}
\addcontentsline{toc}{subsection}{Burrow-Wheeler-Alignment}

\hypertarget{bwa-mem2}{%
\subsection*{BWA-MEM2}\label{bwa-mem2}}
\addcontentsline{toc}{subsection}{BWA-MEM2}
